...
const VideoPlayerMain = () => {
  return (
    <div className="relative flex justify-center items-center w-full mx-auto max-w-[2560px]">
      ...
      <btn className="absolute [padding:_clamp(1.25rem,2.083vw+0.833rem,2.5rem)] bg-transparent border-4 rounded-full btn border-primary text-primary h-fit w-fit">
